...
public class LinkedList<T> {
    ...
    */
    ...
    public static void main(String[] args){
        ...
        // Test add(int index, T o)
        list = new LinkedList<Integer>(new Integer(1));
        list.add(2);
        list.add(3);
        list.add(1, 100);
        ...
        // Test get()
        list = new LinkedList<Integer>(new Integer(52500600));
        list.add(60);
        list.add(500);
        ...
        // Test toString()
        LinkedList<Integer> haha = new LinkedList<Integer>(new Integer(1));
        haha.add(2);
        haha.add(3);
        assert haha.toString().equals( "[1, 2, 3]");
